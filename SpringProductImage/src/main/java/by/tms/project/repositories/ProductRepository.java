...
public class ProductRepository {
    ...
    private static final String INSERT_PRODUCTS = "INSERT INTO products (description, price, image_path) VALUES (?,?,?);";
    ...
    public Product create(Product product){
        try (Connection connection = ConnectionManager.open()) {
            ...
            insertProducts.setString(3,product.getImagePath());
    ...
    public void update(Product product){
        ...
        try(Connection connection = ConnectionManager.open()) {
            PreparedStatement preparedStatement =
                    connection.prepareStatement("update products set description = ?, price = ?, image_path = ? where id = ?;");
